...
//       worker: true,          // ✅ Run in web worker (no UI freeze)
//       complete: (results) => {
...
//         // Extract only phone_numbers column and remove duplicates
...
//         alert(`Parsed ${uniqueNumbers.length} unique phone numbers (${numbers.length - uniqueNumbers.length} duplicates removed). Check console for details.`);
//       },
//     });
//   };
...
//     // Replace this with your sandbox test number
//     // const testNumber = "+918627814026";  
//     const testNumber = "+916284301480";

//     try {
//       const templateName = "hello_world"; // Your template
//       const templateVariables = []; // Or any static test variable

//       const res = await fetch("/api/send-whatsapp", {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({
//           toNumbers: [testNumber],   // Only send to the testing number
//           templateName,
//           templateVariables,
//         }),
//       });
...
//         Logout
//       </button>
//       <div className="p-6 space-y-4 border-2 rounded-lg bg-white shadow-sm">
//         <h1 className="text-2xl font-bold text-gray-800 mb-4">CSV Parser & Phone Number Extractor</h1>
...
//             <h2 className="text-2xl font-bold text-gray-800">Parsed CSV Data</h2>
...
//                   <strong>Large dataset detected:</strong> {csvData.length} rows found.
//                   {showAllRows ? ' Showing all rows.' : ' Showing first 50 rows for optimal performance.'}
//                 </p>
//               </div>
//               <button
//                 onClick={() => {
//                   setShowAllRows(!showAllRows);
//                   setExpandedRows(new Set()); // Reset expanded state
//                 }}
//                 className="px-4 py-2 bg-green-600 text-white text-sm rounded-lg hover:bg-green-700 whitespace-nowrap font-medium"
//               >
...
//               return (
//                 <div key={index} className="border-b last:border-b-0 bg-white">
//                   <button
//                     onClick={() => toggleRow(index)}
//                     className="w-full px-6 py-4 text-left hover:bg-gray-50 flex justify-between items-center transition-colors"
//                   >
//                     <div className="flex items-center gap-4">
...
//                           {rowKeys.map((key) => (
//                             <div key={key} className="flex border-b border-gray-200 pb-2 last:border-b-0 last:pb-0">
//                               <span className="font-semibold text-sm text-gray-700 w-40 flex-shrink-0">
//                                 {key}:
//                               </span>
//                               <span className="text-sm text-gray-900 break-all">
//                                 {row[key] || <span className="text-gray-400 italic">empty</span>}
//                               </span>
//                             </div>
//                           ))}
//                         </div>
...
//                             📋 View Raw JSON Data
//                           </summary>
//                           <pre className="mt-3 p-3 bg-white rounded border text-xs overflow-auto max-h-40 font-mono">
...
//           {csvData.length > 50 && !showAllRows && (
//             <div className="mt-4 text-center">
//               <p className="text-sm text-gray-500">
//                 Showing {Math.min(50, csvData.length)} of {csvData.length} rows.
//                 <button
...
//             <h2 className="text-2xl font-bold text-gray-800">Extracted Phone Numbers (Unique)</h2>
//             <div className="text-sm text-gray-600 bg-green-100 px-3 py-1 rounded-full">
//               {phoneNumbers.length} unique numbers
//             </div>
//           </div>
...
//                 📋 View as JSON Array
//               </summary>
//               <pre className="mt-3 p-3 bg-white rounded border text-xs overflow-auto max-h-32 font-mono">
//                 {JSON.stringify(phoneNumbers, null, 2)}
//               </pre>
//             </details>
//             <button
//               onClick={sendWhatsAppMessages}
//               className="mt-4 px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium"
//             >
//               Send WhatsApp Template to Unique Numbers
//             </button>
//           </div>
//         </div>
//       )}
